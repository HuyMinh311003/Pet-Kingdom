              ...
              <div className="form-group">
                <label htmlFor="promoValue">
                  {newPromotion.type === 'percentage' ? 'Discount Percentage' :
                   newPromotion.type === 'fixed' ? 'Discount Amount (VND)' :
          ...
          <div key={promotion.id} className="promotion-card">
            <div className="promotion-header">
              <div className="promotion-title">
                ...
                <span className={`status-badge ${isPromotionActive(promotion) ? 'active' : 'inactive'}`}>
            ...
            <div className="promotion-details">
              <div className="detail-item">
                ...
                <span className="value">{promotion.type.charAt(0).toUpperCase() + promotion.type.slice(1)}</span>
              </div>
              <div className="detail-item">
                <span className="label">Value:</span>
                <span className="value">
                  {promotion.type === 'percentage' || promotion.type === 'bundle'
                    ? `${promotion.value}%`
              ...
              {promotion.minOrderValue && (
                <div className="detail-item">
                  ...
                  <span className="value">{promotion.minOrderValue.toLocaleString()} VND</span>
                </div>
              )}
              <div className="detail-item">
                <span className="label">Usage:</span>
                <span className="value">{promotion.usageCount} / {promotion.usageLimit}</span>
              </div>
            </div>

            <div className="promotion-actions">
              <button
                className={`status-toggle-btn ${promotion.isActive ? 'deactivate' : 'activate'}`}
                onClick={() => handleUpdateStatus(promotion.id, !promotion.isActive)}
              >
